...
Navigating to Test Runs...`);
  ...
  const menuItems = [
    ...
    { id: 'databasetesting', icon: '💾', label: 'Database Testing', category: 'Testing Tools' },
    ...
    <div className="dashboard-container">
      ...
      <main className="dashboard-main">
        ...
        <div className="dashboard-content">
          ...
          {/* Object Repository */}
          {activeView === 'objectrepository' && <ObjectRepository projectId={selectedProjectId || undefined} />}

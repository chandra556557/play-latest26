...
import { elementDependencyController } from '../controllers/elementDependency.controller';
...
router.post('/dependencies', (req, res, next) => {
  elementDependencyController.createDependency(req, res, next);
});
 ...
 * @access  Private
 */
router.get('/dependencies/element/:elementId', (req, res, next) => {
  elementDependencyController.getDependencyGraph(req, res, next);
});
 ...
 * @access  Private
 */
router.get('/dependencies/impact/:elementId', (req, res, next) => {
  elementDependencyController.analyzeImpact(req, res, next);
});
 ...
 * @access  Private
 */
router.put('/dependencies/:id', (req, res, next) => {
  elementDependencyController.updateDependency(req, res, next);
});
 ...
 * @access  Private
 */
router.delete('/dependencies/:id', (req, res, next) => {
  elementDependencyController.deleteDependency(req, res, next);
});

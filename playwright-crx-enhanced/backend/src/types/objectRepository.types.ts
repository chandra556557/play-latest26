...
export interface DependencyGraph {
  element: UIElement;
  dependencies: ElementDependencyWithDetails[];
  dependents: ElementDependencyWithDetails[];
  hasCircularDependency: boolean;
  impactedElements: string[];
}

export interface ElementDependencyWithDetails extends ElementDependency {
  parentElement: UIElement;
  dependentElement: UIElement;
}
